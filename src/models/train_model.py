...
print("Square features:", len(sqaure_features))
...
feature_set_2 = basic_features + sqaure_features + pca_features
feature_set_3 = list(
    set(basic_features + sqaure_features + pca_features + time_features)
)
feature_set_4 = list(
    set(
        basic_features
...
# --------------------------------------------------------------
# Try a more complexe model with the selected features
# --------------------------------------------------------------
